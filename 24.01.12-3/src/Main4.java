...
//		System.out.println(record3.hashCode());
		Set<EmployeeAttendance> onDay = new HashSet<>();
		onDay.add(record1);
		onDay.add(record2);
		onDay.add(record3);
		
		onDay.add(new EmployeeAttendance("도우너", "출근", "09:00"));
		onDay.add(new EmployeeAttendance("도우너", "퇴근", "18:00"));
